...
const jettonParams = {
	owner: Address.parse("UQBFsYF2FqoBATbmVWTvkUPmZgFSE7Xq2q2RH0Os6NWTmbxO"),
	name: "onTON",
	symbol: "onTON",
	image:
		"https://cache.tonapi.io/imgproxy/X7T-fLahBBVIxXacXAqrsCHIgFgTQE3Jt2HAdnc5_Mc/rs:fill:200:200:1/g:no/aHR0cHM6Ly9zdGF0aWMuc3Rvbi5maS9sb2dvL3Rvbl9zeW1ib2wucG5n.webp", // Image url
	description: "Proxy contract for onTON"
};
...
export function jettonMinterInitData(owner: Address, metadata: { [s in JettonMetaDataKeys]?: string }): Cell {
	return beginCell()
		.storeCoins(0)
		.storeAddress(owner)
...
export async function postDeployTest(walletContract: WalletContract, secretKey: Buffer, contractAddress: Address) {
	...
	console.log(parseTokenMetadataCell(Cell.fromBoc(Buffer.from(call.stack[3][1].bytes, "base64").toString("hex"))[0]));
}
